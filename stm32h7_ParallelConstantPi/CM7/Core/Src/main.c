...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
//StreamBufferHandle_t *const xStreamBuffer = (StreamBufferHandle_t *)0x30000008;
...
/* USER CODE END Boot_Mode_Sequence_2 */
  ...
  /* add mutexes, ... */
//	*xStreamBuffer = xStreamBufferCreate(sizeof(uint16_t),sizeof(uint16_t));
...
{
  /* USER CODE BEGIN 5 */
//	const double cantidadIntervalos = 10000000; //10'000'000
//
//	double baseIntervalo = 1.0 / cantidadIntervalos, fdx, x;
//	double acum = 0;
//	long i;
//
